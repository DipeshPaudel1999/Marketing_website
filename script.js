...
//Smooth scrolling of navigation bar
...
// message.innerHTML =
//   'You just entered Sanatan world! <button class="btn btn--close-cookie"> Allow </button>';
...
//Fade effect on nav link and logo when hover over one nav link
...
//Mouse enter hero image shows alert message but only once
// const heroImg = document.querySelector('.header__img');
// const heroImgHoverMsg = function () {
//   alert('The creator, The Protector and The Destroyer ');
//   heroImg.removeEventListener('mouseenter', heroImgHoverMsg);
// };
// heroImg.addEventListener('mouseenter', heroImgHoverMsg);

//Changing color background color when pressing nav btn
// const navSelector = document.querySelector('.nav__link');
// const randInt = (max, min) => Math.floor(Math.random() * (max - min + 1) + min);
// const randColor = `rgb(${randInt(0, 255)},${randInt(0, 255)},${randInt(
//   0,
//   255
// )})`;
// console.log(randColor);
// navSelector.addEventListener('mouseenter', function (e) {
...
// const x = h1.parentElement.children;
// console.log([...x]);
...
//Tab on Vedas gita and upanisad contents
